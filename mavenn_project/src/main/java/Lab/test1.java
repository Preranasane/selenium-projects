...
//		driver.findElement(By.xpath("//li[@id='patient-tests-labs-option-1']")).click();
		...
		Thread.sleep(10000);
		String exception= driver.findElement(By.xpath("//div[text()='Please select lab in which you want send samples.']")).getText();
	
		 Assert.assertEquals(exception, "Please select lab in which you want send samples.");
	}
